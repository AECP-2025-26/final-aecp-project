...
if uploaded_file is not None:
    try:
        ...
        algorithm_choice = st.selectbox("Which model do you :", ["ARIMA", "SARIMA", "LSTM"])
        ...
        if algorithm_choice == 'LSTM':
            ...
            model = Sequential([LSTM(64, activation='relu', input_shape=(X_train.shape[1], X_train.shape[2])),Dense(1)])
            ...
            model_full = Sequential([LSTM(64, activation='relu', input_shape=(X_full.shape[1], X_full.shape[2])),Dense(1)])
